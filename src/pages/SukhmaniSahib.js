    ...
    return (
        ...
        <div className="dashboard">
            <div className="dashboard-head">
                <h1 className="con-head">Sukhmani Sahib</h1>
            </div>
            <div className="dash-user">
                <div style={{backgroundImage:`url("https://covers.djpunjab.pro/image/482905/Sukhmani-Sahib-Bhai-Harbans-Singh-Ji-Jagadhari-Wale-1.jpg")`,backgroundSize:"100% 100%"}} className="dash-user-head">
                    <div >
                        <audio controls className="audio">
                            <source src="https://www.dhansikhi.com/wp-content/uploads/Audio/Sukhmani_Sahib-Dhansikhi-16kbps.mp3" type="audio/mpeg" className="audio"/>
                        </audio>
                    </div>
                </div>
                <div className="dash-user-body">
                    <h1 className="dash-user-name">Lyrics</h1>
                    <p className="lyrics">Siri Sukhmani Sahib:
...
naanak ih gun naam sukhmanee. ||8||24||</p>
                </div>
