...
const SaraswatiAarti = () => {
    
    return (
        <>
        <div className="dashboard">
            <div className="dashboard-head">
                <h1 className="con-head">Saraswati Aarti</h1>
            </div>
            <div className="dash-user">
                <div style={{backgroundImage:`url("https://c.saavncdn.com/356/Saraswati-Mata-Aarti-Sanskrit-2018-20190108-500x500.jpg")`,backgroundSize:"100% 100%"}} className="dash-user-head">
                    <div >
                        <audio controls className="audio">
                            <source src="https://dns4.pendusaab.com/download/128k-equ/Om-Jai-Saraswati-Mata.mp3" type="audio/mpeg" className="audio"/>
                        </audio>
                    </div>
                </div>
                <div className="dash-user-body">
                    <h1 className="dash-user-name">Lyrics</h1>
                    <p className="lyrics">Jai Saraswati Mata, Maiya Jai Saraswati Mata।
...
Charo yug partap tumhara । Hoee parasiddha jagat ujiyara ॥
॥३०॥
...
॥ जय-घोष / Hail the Lord ॥
बोल बजरंगबली की जय ।
पवन पुत्र हनुमान की जय ॥
Bol Bajarangabali ki jai ।
Pavan putra Hanuman ki hai ॥</p>
                </div>
