    ...
    return (
        ...
        <div className="dashboard">
            <div className="dashboard-head">
                <h1 className="con-head">Japji Sahib</h1>
            </div>
            <div className="dash-user">
                <div style={{backgroundImage:`url("https://www.punjabidharti.com/wp-content/uploads/2016/06/japuji-sahib-1.jpg")`,backgroundSize:"100% 100%"}} className="dash-user-head">
                    <div >
                        <audio controls className="audio">
                            <source src="https://dns4.pendusaab.com/download/128k-alsmu/Japji-Sahib.mp3" type="audio/mpeg" className="audio"/>
                        </audio>
                    </div>
                </div>
                <div className="dash-user-body">
                    <h1 className="dash-user-name">Lyrics</h1>
                    <p className="lyrics">ik-oNkaar sat naam kartaa purakh nirbha-o nirvair
akaal moorat ajoonee saibhaN gur parsaad.
jap.
aad sach jugaad sach.
hai bhee sach naanak hosee bhee sach. ||1||

Japji Sahib with English Subtitles
...
naanak tay mukh ujlay kaytee chhutee naal. ||1||</p>
                </div>
