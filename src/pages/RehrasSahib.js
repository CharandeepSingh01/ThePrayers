    ...
    return (
        ...
        <div className="dashboard">
            <div className="dashboard-head">
                <h1 className="con-head">Rehras Sahib</h1>
            </div>
            <div className="dash-user">
                <div style={{backgroundImage:`url("https://nitnempath.com/wp-content/uploads/2022/03/Rehrass-Sahib-in-English.jpg")`,backgroundSize:"100% 100%"}} className="dash-user-head">
                    <div >
                        <audio controls className="audio">
                            <source src="https://cdnsongs.com/music/data/Shabad_Gurbani/201404/Rehras_Sahib/128/Rehraas_Sahib.mp3" type="audio/mpeg" className="audio"/>
                        </audio>
                    </div>
                </div>
                <div className="dash-user-body">
                    <h1 className="dash-user-name">Lyrics</h1>
                    <p className="lyrics">Salok Mahala 1
